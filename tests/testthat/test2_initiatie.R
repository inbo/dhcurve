...
test_that("Uitzonderingen worden correct afgehandeld", {
  expect_is(
    Output <- initiatie(Dataset,
...
test_that("Dataset mag enkel goedgekeurde gegevens bevatten", {
  expect_is(
    Output <- initiatie(Dataset),
    "list"
  )
...
test_that("Dataset mag geen afgekeurde gegevens bevatten", {
