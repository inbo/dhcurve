...
test_that(
  "Output van fit.basis is correct (tibble met velden BMS en Model)", {
...
Kolomnamen <-
  c("BMS", "DOMEIN_ID", "BOS_BHI", "nBomenInterval", "nBomenOmtrek05", "nBomen",
    "Q5k", "Q95k", "Omtrek", "H_VL_finaal", "IDbms", "C13", "HOOGTE", "Status",
    "ID", "Rijnr", "logOmtrek", "logOmtrek2", "Q5", "Q95")

test_that(
  "Output van fit.afgeleid is correct (list met 2 tibbles)", {
