...
#'
#' Interne functie die de modelparameters berekent op basis van een opgegeven afgeleid model.  Ze berekent de parameter voor de verschuiving van het basismodel.
#'
