...
Dit gebeurt door het model dat gebouwd is op basis van de omtrekklassen binnen het bruikbaar interval, toe te passen op de hogere omtrekklassen (tot 3,0 m), en de curves te valideren met de functie `validatie.uitbreiding()`.
