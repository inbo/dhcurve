...
Op basis van het aantal bomen binnen het bruikbaar interval met omtrek > 0,5 m splitst de functie `initiatie` de dataset op in functie van de verschillende modeltypen (zie [initiatie onder praktische werkwijze](#initiatie)).
