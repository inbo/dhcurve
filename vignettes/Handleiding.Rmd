...
De functie `outputIVANHO` genereert op basis van de berekende (gefitte) modellen een tabel met per boomsoort-domein-combinatie en per diameterklasse een geschatte hoogte, om te gebruiken in IVANHO.
...
De functie `initiatie` berekent per boomsoort-domein-combinatie enkele variabelen die verband houden met dit bruikbaar interval:
