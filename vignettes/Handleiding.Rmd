...
# Lijst maken met alle id's (die in dit geval overeenkomen met 'rownames' in de databank) van de records die aangepast moeten worden
...
ggplot() +
  ...
  geom_segment(aes(x = Omtrek, xend = Omtrek, y = BeginPijl, yend = EindePijl), arrow = arrow(length = unit(1.5, "mm"), type = "closed"))
