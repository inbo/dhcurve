...
Voor het __afgeleid model__, waar het aantal records per boomsoort-domeincombinatie beperkt is, wordt voor elk punt een schatting gemaakt op basis van van een model dat opgesteld is op basis van de dataset zonder dat ene punt, waarna de rmse op dezelfde manier berekend wordt.  (Hiervoor is de functie _rmse.afgeleid_ ontwikkeld.)
